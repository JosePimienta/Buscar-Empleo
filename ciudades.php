...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>CIUDADES | BUSCAR EMPLEOS</title>
    <!-- FONT AWESOME-->
    ...
    <div class="conteiner">
      ...
      <nav class="nav-main">
        ...
        <ul class="nav-menu">
          ...
          <li>
            <a href="ciudades.php" id="color-ciu">Ciudades</a>
          </li>
        </ul>
...
<form class="formulario3" id="form" method="post" onsubmit="return AnanadirT()">
  <a href="#">
    <i class="fas fa-arrow-left" id="cerrar3"></i>
      ...
      <!--imagen principal-->
      <header class="shoucase" id="shoucase-ciudades">
        <h2>Ciudades</h2>
        <p>En este espacio podrá mirar las difererentes ciudades que tienen ofertas de trabajos, de igual manera se encuentra un correo de contacto en el cual podrá realizar cualquier tipo de pregunta.</p>
      </header>
...
if ($inc) {
$consulta = "SELECT ubicacion, contacto FROM datos";
