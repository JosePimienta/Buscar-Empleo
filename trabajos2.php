...
<!--contacto-->
<!--<link rel="stylesheet" 0href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">-->
...
<nav class="conRe">
  ...
  <form action="trabajos2.php" method="post" name="envv" class="b">
