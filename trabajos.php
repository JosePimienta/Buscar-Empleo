    ...
    <div class="conteiner">
      ...
      <nav class="nav-main">
        ...
        <ul class="nav-menu">
          ...
          <li>
            <a href="trabajos.php" class="trab" id="color-tra">Trabajos</a>
          </li>
          <li>
  ...
  while ($row = $resultado->fetch_array()) {
    ...
    <div>
      <div class="uno">
        ...
        <a href="mailto:<?=$row['contacto']?>?Subject=HOJA%20DE%20VIDA:%20Buscar%20empleo&body=En el siguiente correo se adjunta la hoja de vida para el empleo de <?=$row['nombreempleo']?>."><p><?=$row['contacto']?></p></a>
